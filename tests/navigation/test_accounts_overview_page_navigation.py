...
class TestAccountsOverviewPageNavigation:
    ...
    def test_navigation_accounts_overview_to_account_activity(self, driver):
        ...
        with allure.step("Proceed to Account Activity page"):
            account_num = accounts_overview_page.account_id_link.get_text()
    ...
    def test_navigation_accounts_overview_to_about_us(self, driver):
        ...
        with allure.step("Navigate to About Us page via button"):
            accounts_overview_page.about_us_button.click()
    ...
    def test_navigation_accounts_overview_to_find_transactions(self, driver):
        ...
        with allure.step("Proceed to Find Transactions page via link"):
            accounts_overview_page.find_transactions_link.click()
    ...
    def test_navigation_accounts_overview_to_update_profile(self, driver):
        ...
        with allure.step("Proceed to Update Profile page via link"):
            accounts_overview_page.update_contact_info_link.click()
    ...
    def test_navigation_accounts_overview_to_request_loan(self, driver):
        ...
        with allure.step("Proceed to Request Loan page via link"):
            accounts_overview_page.request_loan_link.click()
